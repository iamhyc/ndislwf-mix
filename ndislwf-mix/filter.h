...
#define FILTER_FRIENDLY_NAME        L"ndislwf-mix NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{7158c113-ca83-4264-b0da-7065dfe2a00a}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"ndislwf-mix"
...
DRIVER_DISPATCH ndislwfmixDispatch;

DRIVER_DISPATCH ndislwfmixDeviceIoControl;
